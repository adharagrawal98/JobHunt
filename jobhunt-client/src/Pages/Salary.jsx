            ...
            <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
                ...
                <div className="mt-5">
                    <div className="search-box p-2 text-center mb-2">
                        ...
                        <button onClick={handleSearch} className="bg-blue py-2 px-8 text-white font-semibold rounded-sm mx-2 mb-4">Search</button>
                    </div>
                </div>
                {/* salary display card */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 sm:grid-cols-1 gap-12 my-12 items-center">
                    {salary.map((data) => (
